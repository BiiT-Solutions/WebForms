...
import com.biit.gui.tester.IntegrationTestLogging;
...
import com.biit.webforms.gui.tests.window.*;
...
public class FormManager extends VaadinGuiWebpage {
    ...
    public void createNewForm(String formName) {
        IntegrationTestLogging.debug(this.getClass().getName(), "Removing any old form.");
        deleteAllCreatedForms();
        IntegrationTestLogging.debug(this.getClass().getName(), "Creating a new form '" + formName + "'.");
        openNewFormWindow();
