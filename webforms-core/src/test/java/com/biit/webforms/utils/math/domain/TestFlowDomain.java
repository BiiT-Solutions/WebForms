...
public class TestFlowDomain {
	...
	// }
	//
	// @Test(dependsOnMethods = { "testFlowDomain" }, expectedExceptions = {
	// IncompleteLogic.class })
	// public void testFlowDomainNotCompleteLogicOnlyQuestionAnswer() throws
	...
	// "testFlowDomainNotCompleteLogicOnlyQuestionAnswer" })
	// public void testFlowDomainCompleteLogicWithOr() throws
	...
	// }
	//
	// @Test(dependsOnMethods = { "testFlowDomainCompleteLogicWithOr" },
	// expectedExceptions = { RedundantLogic.class })
