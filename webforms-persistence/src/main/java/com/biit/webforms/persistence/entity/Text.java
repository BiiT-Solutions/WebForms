...
@Cacheable
public class Text extends WebformsBaseQuestion implements ElementWithMedia, ElementWithTranslation {
    ...
    public void copyData(StorableObject object) throws NotValidStorableObjectException {
        if (object instanceof Text) {
            ...
            if (((Text) object).getDescriptionTranslations() != null) {
                descriptionTranslations = new HashMap<>(((Text) object).getDescriptionTranslations());
            }
        } else {
