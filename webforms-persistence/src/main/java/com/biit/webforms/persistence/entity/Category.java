...
@Cacheable()
public class Category extends BaseCategory implements ElementWithMedia, ElementWithTranslation {
    ...
    public void copyData(StorableObject object) throws NotValidStorableObjectException {
        if (object instanceof Category) {
            ...
            if (((Category) object).getDescriptionTranslations() != null) {
                descriptionTranslations = new HashMap<>(((Category) object).getDescriptionTranslations());
            }
        } else {
