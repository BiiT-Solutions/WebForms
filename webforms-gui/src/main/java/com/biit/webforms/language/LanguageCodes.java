...
public enum LanguageCodes implements ILanguageCode {
	...
	CAPTION_EXPORT_ABCD("caption.export.abcd"),
	...
	TOOLTIP_EXPORT_ABCD("tooltip.export.abcd"),
	...
	CAPTION_NEW_ATTACHED_FILES("caption.new.attached.file"),
	...
	CAPTION_ANSWERS_VALUES_ALWAYS_VISIBLE_ON_TOOLTIP("caption.answers.values.visible.on.tooltip"),
	...
	CAPTION_CONSECUTIVE_ANSWERS_TOOLTIP("caption.consecutive.answers.tooltip"),
	CAPTION_REPETABLE("caption.repetable"),
	CAPTION_TABLE("caption.table"),
	CAPTION_NUMBER_OF_COLUMNS("caption.number.of.columns"),
	CAPTION_TOTAL_ANSWERS_VALUES("caption.total.answers.values"),
	...
	CAPTION_PROPERTIES_IMAGE_FILE("caption.properties.image.file"),
	CAPTION_PROPERTIES_IMAGE_URL("caption.properties.image.url"),
	CAPTION_WINDOW_IMAGE_URL("caption.window.image.url"),
	CAPTION_PROPERTIES_IMAGE_WIDTH("caption.properties.image.width"),
	CAPTION_PROPERTIES_IMAGE_HEIGHT("caption.properties.image.height"),
	...
	CAPTION_PROPERTIES_VIDEO_TITLE("caption.properties.video.title"),
	...
	CAPTION_VALIDATE_TABLE_ONLY_QUESTIONS_AS_COLUMNS("caption.validate.table.only.questions.as.columns"),
	CAPTION_VALIDATE_TABLE_DIFFERENT_NUMBER_OF_COLUMNS("caption.validate.table.different.number.columns"),
	CAPTION_VALIDATE_TABLE_DIFFERENT_COLUMNS("caption.validate.table.different.columns"),
	...
	TOOLTIP_NEW_ATTACHED_FILES("tooltip.new.attached.file"),
