...
public class TableTreeObject extends TreeTable {
    ...
    private final Map<String, TreeObject> rootElements;
    ...
    public TableTreeObject() {
        ...
        expandListener = event -> setValue(event.getItemId());
        collapseListener = event -> setValue(event.getItemId());
    ...
    private void removeUnexistingChildren(TreeObject element) {
        ...
        if (immutableList != null && (!immutableList.isEmpty())) {
            List<Object> children = new ArrayList<>(immutableList);
